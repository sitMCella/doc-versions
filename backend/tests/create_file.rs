...
#[tokio::test]
async fn create_file_returns_500_for_initialized_repository() {
...
#[tokio::test]
async fn create_file_returns_200_for_repository_with_master_branch() {
    let workspace_name = get_workspace_name();
    let configuration_file = configure_test(&workspace_name).unwrap_or_else(|error| {
        panic!("Error while configuring the test: {:?}.", error);
    });
...
#[tokio::test]
async fn create_file_creates_new_commit_for_repository_with_master_branch() {
    let workspace_name = get_workspace_name();
    let configuration_file = configure_test(&workspace_name).unwrap_or_else(|error| {
        panic!("Error while configuring the test: {:?}.", error);
    });
...
#[tokio::test]
async fn create_file_creates_new_file_for_repository_with_master_branch() {
    let workspace_name = get_workspace_name();
    let configuration_file = configure_test(&workspace_name).unwrap_or_else(|error| {
        panic!("Error while configuring the test: {:?}.", error);
    });
...
#[tokio::test]
async fn create_file_returns_409_for_repository_with_master_branch_and_already_created_file() {
    let workspace_name = get_workspace_name();
    let configuration_file = configure_test(&workspace_name).unwrap_or_else(|error| {
        panic!("Error while configuring the test: {:?}.", error);
    });
